...
import { Camera, Bug, Calendar } from 'lucide-react';
...
const severityBadge: Record<string, { bg: string; text: string; labelHi: string }> = {
  healthy: { bg: 'bg-green-100', text: 'text-green-800', labelHi: 'स्वस्थ' },
...
export function HistoryPage() {
  ...
  useEffect(() => {
    apiClient<ApiResponse<DiagnosisHistoryItem[]>>('/diagnoses?sort=-createdAt')
            ...
            >
              ...
              <div className="flex-1 min-w-0">
                <p className="text-lg font-bold text-earth-900 truncate">
                  {d.diseaseNameHindi || d.diseaseName}
                </p>
